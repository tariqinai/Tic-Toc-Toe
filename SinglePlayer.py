...
class SinglePlayer(TicTocToe):
  ...
  def __init__(self):
    ...
    self.num2 = rd.randint(1,9)
    self.computerSym = "$"
    self.historyC = []
    self.masterHistory.append(self.historyC)
